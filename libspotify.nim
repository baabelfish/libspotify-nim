...
template SP_TOPLIST_REGION*(a, b: expr): expr = ((a) shl 8 or (b))
...
type
  ...
  sp_session_callbacks* = object 
    ...
    music_delivery*:               proc (session: ptr sp_session; format: ptr sp_audioformat; frames: pointer; num_frames: cint): cint
    ...
    get_audio_buffer_stats*:       proc (session: ptr sp_session; stats: ptr sp_audio_buffer_stats)
    ...
    private_session_mode_changed*: proc (session: ptr sp_session; is_private: bool)
  ...
  sp_playlist_callbacks* = object 
    tracks_added*:                proc (pl: ptr sp_playlist; tracks: ptr ptr sp_track; num_tracks: cint; position: cint; userdata: pointer)
    tracks_removed*:              proc (pl: ptr sp_playlist; tracks: ptr cint; num_tracks: cint; userdata: pointer)
    tracks_moved*:                proc (pl: ptr sp_playlist; tracks: ptr cint; num_tracks: cint; new_position: cint; userdata: pointer)
    playlist_renamed*:            proc (pl: ptr sp_playlist; userdata: pointer)
    playlist_state_changed*:      proc (pl: ptr sp_playlist; userdata: pointer)
    playlist_update_in_progress*: proc (pl: ptr sp_playlist; done: bool; userdata: pointer)
    playlist_metadata_updated*:   proc (pl: ptr sp_playlist; userdata: pointer)
    track_created_changed*:       proc (pl: ptr sp_playlist; position: cint; user: ptr sp_user; `when`: cint; userdata: pointer)
    track_seen_changed*:          proc (pl: ptr sp_playlist; position: cint; seen: bool; userdata: pointer)
    description_changed*:         proc (pl: ptr sp_playlist; desc: cstring; userdata: pointer)
    image_changed*:               proc (pl: ptr sp_playlist; image: ptr byte; userdata: pointer)
    track_message_changed*:       proc (pl: ptr sp_playlist; position: cint; message: cstring; userdata: pointer)
    subscribers_changed*:         proc (pl: ptr sp_playlist; userdata: pointer)

  sp_playlistcontainer_callbacks* = object 
    playlist_added*:   proc (pc: ptr sp_playlistcontainer; playlist: ptr sp_playlist; position: cint; userdata:     pointer)
    playlist_removed*: proc (pc: ptr sp_playlistcontainer; playlist: ptr sp_playlist; position: cint; userdata:     pointer)
    playlist_moved*:   proc (pc: ptr sp_playlistcontainer; playlist: ptr sp_playlist; position: cint; new_position: cint; userdata: pointer)
  ...
  artistbrowse_complete_cb*  = proc (result: ptr sp_artistbrowse;  userdata: pointer)
  ...
  toplistbrowse_complete_cb* = proc (result: ptr sp_toplistbrowse; userdata: pointer)
...
proc sp_albumbrowse_create*(session: ptr sp_session; album: ptr sp_album; callback: ptr albumbrowse_complete_cb; userdata: pointer): ptr sp_albumbrowse {. cdecl, importc: "sp_albumbrowse_create", dynlib: sf_dynlib .}
...
proc sp_artistbrowse_create*(session: ptr sp_session; artist: ptr sp_artist; `type`: sp_artistbrowse_type; callback: ptr artistbrowse_complete_cb; userdata: pointer): ptr sp_artistbrowse {. cdecl, importc: "sp_artistbrowse_create", dynlib: sf_dynlib .}
...
proc sp_image_add_load_callback*(image: ptr sp_image; callback: ptr image_loaded_cb; userdata: pointer): sp_error {. cdecl, importc: "sp_image_add_load_callback", dynlib: sf_dynlib .}
...
proc sp_image_remove_load_callback*(image: ptr sp_image; callback: ptr image_loaded_cb; userdata: pointer): sp_error {. cdecl, importc: "sp_image_remove_load_callback", dynlib: sf_dynlib .}
...
proc sp_inbox_post_tracks*(session: ptr sp_session; user: cstring; tracks: ptr ptr sp_track; num_tracks: cint; message: cstring; callback: ptr inboxpost_complete_cb; userdata: pointer): ptr sp_inbox {. cdecl, importc: "sp_inbox_post_tracks", dynlib: sf_dynlib .}
...
proc sp_link_create_from_artist_portrait*(artist: ptr sp_artist; size: sp_image_size): ptr sp_link {. cdecl, importc: "sp_link_create_from_artist_portrait", dynlib: sf_dynlib .}
proc sp_link_create_from_artistbrowse_portrait*(arb: ptr sp_artistbrowse; index: cint): ptr sp_link {. cdecl, importc: "sp_link_create_from_artistbrowse_portrait", dynlib: sf_dynlib .}
...
proc sp_localtrack_create*(artist: cstring; title: cstring; album: cstring; length: cint): ptr sp_track {. cdecl, importc: "sp_localtrack_create", dynlib: sf_dynlib .}
proc sp_offline_num_playlists*(session: ptr sp_session): cint {. cdecl, importc: "sp_offline_num_playlists", dynlib: sf_dynlib .}
proc sp_offline_sync_get_status*(session: ptr sp_session; status: ptr sp_offline_sync_status): bool {. cdecl, importc: "sp_offline_sync_get_status", dynlib: sf_dynlib .}
...
proc sp_playlist_add_callbacks*(playlist: ptr sp_playlist; callbacks: ptr sp_playlist_callbacks; userdata: pointer): sp_error {. cdecl, importc: "sp_playlist_add_callbacks", dynlib: sf_dynlib .}
proc sp_playlist_add_ref*(playlist: ptr sp_playlist): sp_error {. cdecl, importc: "sp_playlist_add_ref", dynlib: sf_dynlib .}
proc sp_playlist_add_tracks*(playlist: ptr sp_playlist; tracks: ptr ptr sp_track; num_tracks: cint; position: cint; session: ptr sp_session): sp_error {. cdecl, importc: "sp_playlist_add_tracks", dynlib: sf_dynlib .}
...
proc sp_playlist_get_offline_download_completed*(session: ptr sp_session; playlist: ptr sp_playlist): cint {. cdecl, importc: "sp_playlist_get_offline_download_completed", dynlib: sf_dynlib .}
proc sp_playlist_get_offline_status*(session: ptr sp_session; playlist: ptr sp_playlist): sp_playlist_offline_status {. cdecl, importc: "sp_playlist_get_offline_status", dynlib: sf_dynlib .}
...
proc sp_playlist_remove_callbacks*(playlist: ptr sp_playlist; callbacks: ptr sp_playlist_callbacks; userdata: pointer): sp_error {. cdecl, importc: "sp_playlist_remove_callbacks", dynlib: sf_dynlib .}
proc sp_playlist_remove_tracks*(playlist: ptr sp_playlist; tracks: ptr cint; num_tracks: cint): sp_error {. cdecl, importc: "sp_playlist_remove_tracks", dynlib: sf_dynlib .}
...
proc sp_playlist_reorder_tracks*(playlist: ptr sp_playlist; tracks: ptr cint; num_tracks: cint; new_position: cint): sp_error {. cdecl, importc: "sp_playlist_reorder_tracks", dynlib: sf_dynlib .}
...
proc sp_playlist_set_collaborative*(playlist: ptr sp_playlist; collaborative: bool): sp_error {. cdecl, importc: "sp_playlist_set_collaborative", dynlib: sf_dynlib .}
proc sp_playlist_set_in_ram*(session: ptr sp_session; playlist: ptr sp_playlist; in_ram: bool): sp_error {. cdecl, importc: "sp_playlist_set_in_ram", dynlib: sf_dynlib .}
proc sp_playlist_set_offline_mode*(session: ptr sp_session; playlist: ptr sp_playlist; offline: bool): sp_error {. cdecl, importc: "sp_playlist_set_offline_mode", dynlib: sf_dynlib .}
...
proc sp_playlist_track_set_seen*(playlist: ptr sp_playlist; index: cint; seen: bool): sp_error {. cdecl, importc: "sp_playlist_track_set_seen", dynlib: sf_dynlib .}
proc sp_playlist_update_subscribers*(session: ptr sp_session; playlist: ptr sp_playlist): sp_error {. cdecl, importc: "sp_playlist_update_subscribers", dynlib: sf_dynlib .}
proc sp_playlistcontainer_add_callbacks*(pc: ptr sp_playlistcontainer; callbacks: ptr sp_playlistcontainer_callbacks; userdata: pointer): sp_error {. cdecl, importc: "sp_playlistcontainer_add_callbacks", dynlib: sf_dynlib .}
proc sp_playlistcontainer_add_folder*(pc: ptr sp_playlistcontainer; index: cint; name: cstring): sp_error {. cdecl, importc: "sp_playlistcontainer_add_folder", dynlib: sf_dynlib .}
proc sp_playlistcontainer_add_new_playlist*(pc: ptr sp_playlistcontainer; name: cstring): ptr sp_playlist {. cdecl, importc: "sp_playlistcontainer_add_new_playlist", dynlib: sf_dynlib .}
proc sp_playlistcontainer_add_playlist*(pc: ptr sp_playlistcontainer; link: ptr sp_link): ptr sp_playlist {. cdecl, importc: "sp_playlistcontainer_add_playlist", dynlib: sf_dynlib .}
...
proc sp_playlistcontainer_clear_unseen_tracks*(pc: ptr sp_playlistcontainer; playlist: ptr sp_playlist): cint {. cdecl, importc: "sp_playlistcontainer_clear_unseen_tracks", dynlib: sf_dynlib .}
proc sp_playlistcontainer_get_unseen_tracks*(pc: ptr sp_playlistcontainer; playlist: ptr sp_playlist; tracks: ptr ptr sp_track; num_tracks: cint): cint {. cdecl, importc: "sp_playlistcontainer_get_unseen_tracks", dynlib: sf_dynlib .}
...
proc sp_playlistcontainer_move_playlist*(pc: ptr sp_playlistcontainer; index: cint; new_position: cint; dry_run: bool): sp_error {. cdecl, importc: "sp_playlistcontainer_move_playlist", dynlib: sf_dynlib .}
...
proc sp_playlistcontainer_playlist_folder_id*(pc: ptr sp_playlistcontainer; index: cint): sp_uint64 {. cdecl, importc: "sp_playlistcontainer_playlist_folder_id", dynlib: sf_dynlib .}
proc sp_playlistcontainer_playlist_folder_name*(pc: ptr sp_playlistcontainer; index: cint; buffer: cstring; buffer_size: cint): sp_error {. cdecl, importc: "sp_playlistcontainer_playlist_folder_name", dynlib: sf_dynlib .}
proc sp_playlistcontainer_playlist_type*(pc: ptr sp_playlistcontainer; index: cint): sp_playlist_type {. cdecl, importc: "sp_playlistcontainer_playlist_type", dynlib: sf_dynlib .}
...
proc sp_playlistcontainer_remove_callbacks*(pc: ptr sp_playlistcontainer; callbacks: ptr sp_playlistcontainer_callbacks; userdata: pointer): sp_error {. cdecl, importc: "sp_playlistcontainer_remove_callbacks", dynlib: sf_dynlib .}
proc sp_playlistcontainer_remove_playlist*(pc: ptr sp_playlistcontainer; index: cint): sp_error {. cdecl, importc: "sp_playlistcontainer_remove_playlist", dynlib: sf_dynlib .}
...
proc sp_search_create*(session: ptr sp_session; query: cstring; track_offset: cint; track_count: cint; album_offset: cint; album_count: cint; artist_offset: cint; artist_count: cint; playlist_offset: cint; playlist_count: cint; search_type: sp_search_type; callback: ptr search_complete_cb; userdata: pointer): ptr sp_search {. cdecl, importc: "sp_search_create", dynlib: sf_dynlib .}
...
proc sp_session_is_scrobbling*(session: ptr sp_session; provider: sp_social_provider; state: ptr sp_scrobbling_state): sp_error {. cdecl, importc: "sp_session_is_scrobbling", dynlib: sf_dynlib .}
proc sp_session_is_scrobbling_possible*(session: ptr sp_session; provider: sp_social_provider; `out`: ptr bool): sp_error {. cdecl, importc: "sp_session_is_scrobbling_possible", dynlib: sf_dynlib .}
proc sp_session_login*(session: ptr sp_session; username: cstring; password: cstring; remember_me: bool; blob: cstring): sp_error {. cdecl, importc: "sp_session_login", dynlib: sf_dynlib .}
...
proc sp_session_preferred_offline_bitrate*(session: ptr sp_session; bitrate: sp_bitrate; allow_resync: bool): sp_error {. cdecl, importc: "sp_session_preferred_offline_bitrate", dynlib: sf_dynlib .}
...
proc sp_session_publishedcontainer_for_user_create*(session: ptr sp_session; canonical_username: cstring): ptr sp_playlistcontainer {. cdecl, importc: "sp_session_publishedcontainer_for_user_create", dynlib: sf_dynlib .}
...
proc sp_session_remembered_user*(session: ptr sp_session; buffer: cstring; buffer_size: csize): cint {. cdecl, importc: "sp_session_remembered_user", dynlib: sf_dynlib .}
...
proc sp_session_set_connection_rules*(session: ptr sp_session; rules: sp_connection_rules): sp_error {. cdecl, importc: "sp_session_set_connection_rules", dynlib: sf_dynlib .}
proc sp_session_set_connection_type*(session: ptr sp_session; `type`: sp_connection_type): sp_error {. cdecl, importc: "sp_session_set_connection_type", dynlib: sf_dynlib .}
...
proc sp_session_set_scrobbling*(session: ptr sp_session; provider: sp_social_provider; state: sp_scrobbling_state): sp_error {. cdecl, importc: "sp_session_set_scrobbling", dynlib: sf_dynlib .}
proc sp_session_set_social_credentials*(session: ptr sp_session; provider: sp_social_provider; username: cstring; password: cstring): sp_error {. cdecl, importc: "sp_session_set_social_credentials", dynlib: sf_dynlib .}
...
proc sp_session_starred_for_user_create*(session: ptr sp_session; canonical_username: cstring): ptr sp_playlist {. cdecl, importc: "sp_session_starred_for_user_create", dynlib: sf_dynlib .}
...
proc sp_toplistbrowse_create*(session: ptr sp_session; `type`: sp_toplisttype; region: sp_toplistregion; username: cstring; callback: ptr toplistbrowse_complete_cb; userdata: pointer): ptr sp_toplistbrowse {. cdecl, importc: "sp_toplistbrowse_create", dynlib: sf_dynlib .}
...
proc sp_track_set_starred*(session: ptr sp_session; tracks: ptr ptr sp_track; num_tracks: cint; star: bool): sp_error {. cdecl, importc: "sp_track_set_starred", dynlib: sf_dynlib .}
